...
const realFileBtn = document.getElementById("fileTitulo");
...
realFileBtn.addEventListener("change", function () {
    if (realFileBtn.value) {
        ...
        customTxt.innerHTML = "Ningun archivo selecionado.";
    }
});



const realFileBtn2 = document.getElementById("fileCvc");
...
realFileBtn2.addEventListener("change", function () {
    if (realFileBtn2.value) {
        ...
        customTxt2.innerHTML = "Ningun archivo selecionado.";
    }
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    checkbox.addEventListener('change', function () {
        if (checkbox.checked) {
            window.location.href = 'RegisterNurse.aspx';
        } else {
            window.location.href = 'RegisterPaciente.aspx';
        }
    });
});
